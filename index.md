...
<div style="margin: 20px 0; display: flex; flex-wrap: wrap; gap: 20px;">
  ...
  <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/Google_Scholar_logo_2015.png"
       alt="Google Scholar"
       style="width: 26px; height: 26px; vertical-align: middle; margin-right: 6px; background: white; border-radius: 50%; padding: 3px;">
  Google Scholar:
</strong><br>
  ...
  <div style="flex: 1; min-width: 200px;">
    ...
    <p><strong><img src="https://upload.wikimedia.org/wikipedia/commons/2/26/Scopus_logo.svg" alt="Scopus" style="width: 26px; height: 26px; vertical-align: middle; margin-right: 6px;"> Scopus:</strong><br>
    <a href="https://www.scopus.com/authid/detail.uri?authorId=57207760617" target="_blank">Link</a></p>
    
    <p><strong><img src="https://upload.wikimedia.org/wikipedia/en/f/f3/Web_of_Science_Logo.png" alt="Web of Science" style="width: 26px; height: 26px; vertical-align: middle; margin-right: 6px;"> Web of Science:</strong><br>
